...
// Informatika.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInformatikaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInformatikaApp

CInformatikaApp::CInformatikaApp()
{
...
// Единственный объект CInformatikaApp

CInformatikaApp theApp;


// Инициализация CInformatikaApp

BOOL CInformatikaApp::InitInstance()
{
